...
const git = simpleGit();
const githubShit = require('./githubthing.js');
...
var githubget = function(query,length)
{
    ...
    //var ass = githubShit.search(query,length);
    //console.log(githubShit.search(query,length));
    return (githubShit.search(query,length));
}
